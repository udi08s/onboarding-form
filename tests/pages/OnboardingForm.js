...
export class OnboardingFormPage {
  constructor(page) {
    ...
    this.stateDropdown = page
      .getByRole("combobox")
      .filter({ hasText: "Select your state" });
    ...
    this.firstNameMinLengthError = page.getByText(
      "First name must be at least 2 characters",
    );
    this.lastNameRequiredError = page.getByText("Last name is required");
    this.lastNameMinLengthError = page.getByText(
    ...
    this.dateOfBirthFutureError = page.getByText(
      "Date of birth cannot be in the future",
    );
    this.dateOfBirthTooYoungError = page.getByText(
      "You must be at least 13 years old",
    );
    this.dateOfBirthTooOldError = page.getByText(
    ...
    this.companyMinLengthError = page.getByText(
  ...
  async selectGender(genderName) {
    ...
    await this.page
      .getByRole("option", { name: genderName, exact: true })
      .click();
  }
